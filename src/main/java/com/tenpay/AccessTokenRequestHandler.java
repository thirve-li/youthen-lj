...
public class AccessTokenRequestHandler extends RequestHandler {
    ...
    public AccessTokenRequestHandler(final HttpServletRequest request,
    ...
    private static boolean tokenIsExpire(final String access_token) {
        ...
        // 发送请求
        final String accesstoken = wxReqHandler.sendAccessToken();
        if (ConstantUtil.EXPIRE_ERRCODE.equals(accesstoken) || ConstantUtil.FAIL_ERRCODE.equals(accesstoken)) flag =
                true;
        return flag;
    }
