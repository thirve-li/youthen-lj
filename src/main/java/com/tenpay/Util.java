...
public class Util {
    ...
    public static Object getObjectFromXML(final String xml, final Class tClass) {
    ...
    public static String getStringFromMap(final Map<String, Object> map, final String key, final String defaultValue) {
        if (key == "" || key == null) {
            return defaultValue;
        }
    ...
    public static int getIntFromMap(final Map<String, Object> map, final String key) {
        if (key == "" || key == null) {
            return 0;
        }
        if (map.get(key) == null) {
     ...
     * @return 读到的xml字符串
     */
    public static String getLocalXMLString(final String localPath) throws IOException {
